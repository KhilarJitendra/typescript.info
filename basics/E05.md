...
2. [Optional & Readonly Properties](#optional--readonly-properties)
3. [Extending Types](#extending-types)
4. [Generic Objects](#generic-objects)
5. [Arrays & Tuples](#arrays--tuples)
...
function visit(home: Home) {
  home.resident.age++;  // ✅ OK - can mutate properties
  // home.resident = {}; // ❌ Error - cannot reassign
}
```
...
function processData(values: readonly string[]) {
  console.log(values[0]);  // ✅ Can read
  // values.push("new");   // ❌ Cannot mutate
}
```
...
// ✅ Type alias - unions and computed types
...
config.settings.theme = "light";  // ✅ OK - can mutate
// config.settings = {};          // ❌ Error - cannot reassign
```
