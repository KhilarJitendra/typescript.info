...
## Table of Contents
1. [What is tsconfig.json?](#what-is-tsconfigjson)
2. [Essential Compiler Options](#essential-compiler-options)
3. [Project Structure Settings](#project-structure-settings)
