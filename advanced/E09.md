...
3. [TypeScript-Specific Features](#typescript-specific-features)
4. [CommonJS Interoperability](#commonjs-interoperability)
5. [Module Resolution & Configuration](#module-resolution--configuration)
